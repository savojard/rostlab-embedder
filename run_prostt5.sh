...
if [[ $# -lt 4 ]]; then
  ...
  echo "  dtype: computation dtype passed through to the container (e.g., fp16 or fp32)." >&2
...
docker run --user $(id -u):$(id -g) \
           ...
           docker.beverara.biocomp.unibo.it:5000/rostlab --model-dir "/rostlab-models/${prostt5_model_id}" --out-dir /workspace/output_dir --save-per-residue --pooling none --output-dtype "${dtype}" ${shard_flag} /workspace/input-fasta.fa
