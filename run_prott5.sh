...
docker run --user $(id -u):$(id -g) \
           ...
           --rm --gpus all \
           docker.beverara.biocomp.unibo.it:5000/rostlab --model-dir "/rostlab-models/${prott5_model_id}" --out-dir /workspace/output_dir --save-per-residue --pooling none --output-dtype "${dtype}" ${shard_flag} /workspace/input-fasta.fa
